...
class TestComment(unittest.TestCase):
    ...
    def setUp(self):    
        ...
        self.new_pitch = Pitch(title = "lol", user = self.new_user)
        self.new_comment = Comment(content = "haha", user = self.new_user, pitch = self.new_pitch)
    ...
    def test_init(self):
        ...
        """
        self.assertEquals(self.new_comment.content, "haha")
    ...
    def test_relationship_picth(self):
        ...
        self.assertTrue(pitch_title == "lol")
